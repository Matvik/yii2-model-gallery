...
<label id="gallery-form-widget-input-files-trigger" for="gallery-form-widget-input-files">Load</label>
<button type="button" id="gallery-form-widget-input-files-clear">Clear</button>
